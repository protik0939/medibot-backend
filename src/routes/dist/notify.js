...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                notification = new Notification_1["default"]({ message: message });
                return [4 /*yield*/, notification.save()];
            case 2:
                _a.sent();
                console.log("✅ New Notification:", message);
                return [4 /*yield*/, oneSignalClient.createNotification({
                        contents: { en: message },
            ...
            case 4:
                err_1 = _a.sent();
                console.error("❌ Notification Error:", err_1.message);
...
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var notifications, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Notification_1["default"].find().sort({ timestamp: -1 })];
            case 1:
